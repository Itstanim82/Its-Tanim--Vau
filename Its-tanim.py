...
"""
logo2 = """
\x1b[1;92m➣ NAME :           💗 TANIM AHAMED 💗
\x1b[1;91m➣ PGE NAME :  💣TERMUX TEACHER TANIM💣
\x1b[1;93m➣ WHATSAPP NO :   👬 +8801784568670 👬
...
def menu():
	os.system('clear')
	print logo
	print "\033[1;96m💖━━━━━━━━━💘💘💘(MAFIA-KILLER-TANIM)💘💘💘━━━━━━━━💖\n" 
...
def action():
	...
	if ahmad =='':
		...
		os.system('xdg-open https://youtube.com/c/TANIMTechnologychannel')
		login()
	elif ahmad =='0':
		exb()
	else:
		...
		try:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q['error_msg']:
					print '\033[1;96m[TANIM-Checkpoint] ' + k + c + user + '  》  ' + pass1+'\n'
